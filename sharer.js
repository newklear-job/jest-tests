...
// { data: { permissions: [ { emailAddress: 'xanf@xanf.me' }]}}
// находим еще незаэнроленных
// добавляем им пермишны


/*
* + Емейл є в списку оплат, є в списку шерів
* + Емейл є в списку оплат немає в списку шерів
* Емейла немає в списку оплат, є в списку шерів
* Емейла немає в списку оплат немає в списку шерів
* */
module.exports = {
